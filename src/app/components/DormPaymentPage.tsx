                ...
                <button
                  onClick={() => {
                    ...
                    onConsent({
                      ...
                      onApprove: () => {
                        setVcShared(true);
                        localStorage.setItem('trustwallet_p1_disclosed_fields', JSON.stringify(req.vcFields!.filter(f => f.required || sharedOptional.has(f.id)).map(f => f.id)));
                        localStorage.setItem('trustwallet_p1_verified', 'true');
                      }
                    });
                  }}
